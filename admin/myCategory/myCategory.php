            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>List Category</h4>
                        <a href="../createCategory/createCategory.php" class="btn btn-primary float-end"><i class="fa-solid fa-plus" style="margin-right: 5px;"></i>Add category</a>
                    </div>
                    <div class="card-body">
                                ...
                                while ($row = $result->fetch_assoc()){
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="../editCategory/editCategory.php?CateId=<?=$row['CateId'] ?>" class="btn btn-success"><i class="fa-solid fa-pen-to-square" style="margin-right: 5px;"></i>Edit</a></td>
                                            <td>
                                                <form action="../deleteCategory/deleteCategoryAction.php?CateId=<?=$row['CateId']?>" method="POST">
