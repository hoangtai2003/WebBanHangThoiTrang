...
<body>
    ...
    <div class="container-new-product">
        ...
        <form class="form-create-product" action="../editCategory/editCategoryAction.php?CateId=<?php echo $CateId ?>" method="post" enctype="multipart/form-data" style="margin: 0 auto; text-align: center">
            <span>
